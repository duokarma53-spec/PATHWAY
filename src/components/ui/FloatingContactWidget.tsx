...
export function FloatingContactWidget() {
  ...
  return (
    <>
      ...
      {/* Mobile Widget */}
      <div className="md:hidden fixed bottom-6 right-6 z-[90] flex flex-col items-end gap-4 pointer-events-auto">
        <div
          className={`flex flex-col gap-4 transition-all duration-300 origin-bottom right-0 ${
        ...
        >
          ...
          <a
            href={`mailto:${MAIL}`}
            className="w-12 h-12 rounded-full bg-midnight text-white shadow-lg flex items-center justify-center"
            aria-label="Email us"
          >
            <Mail size={20} />
          </a>
          ...
          <a
            href={`tel:+${PHONE_RAW}`}
            className="w-12 h-12 rounded-full bg-red-600 text-white shadow-lg flex items-center justify-center"
            aria-label="Call us"
          >
            <Phone size={20} />
          </a>
        ...
        <button
          ...
          className="w-14 h-14 rounded-full bg-navy flex items-center justify-center text-white shadow-xl hover:bg-navy/90 transition-colors"
